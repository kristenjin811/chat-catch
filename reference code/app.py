...
# # from controllers import get_room,
# remove_user_from_room,
# sadd_user_to_room, upload_message_to_room
...
#         # wait for messages
#         while True:
#             if websocket.application_state ==
# WebSocketState.CONNECTED:
#                 data = await websocket.receive_text()
#                 message_data = json.loads(data)
#                 if "type" in message_data and
# message_data["type"] == "dismissal":
...
#             else:
#                 logger.warning(f"Websocket state:
#  {websocket.application_state}, reconnecting...")
#                 await manager.connect(websocket, room_name)
